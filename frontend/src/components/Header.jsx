        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12">
          <div className="flex flex-wrap items-center justify-between gap-3 py-3">
            <Link to={"/"} className="flex items-center gap-x-2 select-none">
              <span className="border-l-[3px] border-secondaryRed pl-2 font-extrabold tracking-tight leading-tight">
                <span className="block text-base sm:text-lg md:text-xl text-secondary">Demo</span>
                <span className="block text-[10px] sm:text-xs md:text-sm text-gray-800 tracking-widest uppercase">RealEstate</span>
              </span>
            </Link>
